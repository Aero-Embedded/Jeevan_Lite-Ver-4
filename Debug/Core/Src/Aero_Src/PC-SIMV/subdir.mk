...
C_DEPS += \
./Core/Src/Aero_Src/PC-SIMV/Pc_Simv_Assist_OFF.d \
./Core/Src/Aero_Src/PC-SIMV/Pc_Simv_Assist_ON.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/Aero_Src/PC-SIMV/%.o: ../Core/Src/Aero_Src/PC-SIMV/%.c Core/Src/Aero_Src/PC-SIMV/subdir.mk
...
clean: clean-Core-2f-Src-2f-Aero_Src-2f-PC-2d-SIMV

clean-Core-2f-Src-2f-Aero_Src-2f-PC-2d-SIMV:
	-$(RM) ./Core/Src/Aero_Src/PC-SIMV/Pc_Simv_Assist_OFF.d ./Core/Src/Aero_Src/PC-SIMV/Pc_Simv_Assist_OFF.o ./Core/Src/Aero_Src/PC-SIMV/Pc_Simv_Assist_ON.d ./Core/Src/Aero_Src/PC-SIMV/Pc_Simv_Assist_ON.o

.PHONY: clean-Core-2f-Src-2f-Aero_Src-2f-PC-2d-SIMV
